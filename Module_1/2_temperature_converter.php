                ...
                <div class="card text-dark bg-info mb-3" style="">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <button type="submit" class="btn btn-primary" name="btn_1">Celsius to Fahrenheit</button>
                            <button type="submit" class="btn btn-primary" name="btn_2">Fahrenheit to Celsius</button>
                        </form>
                    </div>
                    ...
                    <h2>The Result is : <?php
                                        if (isset($_POST['one'])) {
                                            if (isset($_POST['btn_1'])) {
                                                print_r (($_POST['one']* 9/5) + 32);
                                            }
                                            if (isset($_POST['btn_2'])) {
                                                print_r (($_POST['one'] - 32)*5/9) ;
                                            }
                                        }
