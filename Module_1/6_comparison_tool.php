                ...
                <div class="card text-dark bg-info mb-3" style="">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <button type="submit" class="btn btn-primary" name=" add_btn">Compare</button>
...
if (isset($_POST['one']) && ($_POST['two'])) {
    if (isset($_POST['add_btn'])) {
        if ($_POST['one'] > $_POST['two']) {
            print_r("The larger Number is ". $_POST['one']);
        }elseif ($_POST['one'] < $_POST['two']) {
            print_r("The larger Number is ". $_POST['two']) ;
        }
        else {
            print_r("The Numbers are Equal") ;
        }
    }
}
